...
public class CreateJobBean {
    ...
    @CsvBindByName(column = "problems_id")
    private String problems_id;

    @CsvBindByName(column = "problems_remark")
    private String problems_remark;
    ...
    public String toString() {
        return "CreateJobBean{" +
                ...
                ", customer_first_name='" + customer__first_name + '\'' +
                ", customer_last_name='" + customer__last_name + '\'' +
                ", customer_mobile_number='" + customer__mobile_number + '\'' +
                ", customer_mobile_number_alt='" + customer__mobile_number_alt + '\'' +
                ", customer_email_id='" + customer__email_id + '\'' +
                ", customer_email_id_alt='" + customer__email_id_alt + '\'' +
                ", customer_address_flat_number='" + customer_address__flat_number + '\'' +
                ", customer_address_apartment_name='" + customer_address__apartment_name + '\'' +
                ", customer_address_street_name='" + customer_address__street_name + '\'' +
                ", customer_address_landmark='" + customer_address__landmark + '\'' +
                ", customer_address_area='" + customer_address__area + '\'' +
                ", customer_address_pincode='" + customer_address__pincode + '\'' +
                ", customer_address_country='" + customer_address__country + '\'' +
                ", customer_address_state='" + customer_address__state + '\'' +
                ", customer_product_dop='" + customer_product__dop + '\'' +
                ", customer_product_serial_number='" + customer_product__serial_number + '\'' +
                ", customer_product_imei1='" + customer_product__imei1 + '\'' +
                ", customer_product_imei2='" + customer_product__imei2 + '\'' +
                ", customer_product_popurl='" + customer_product__popurl + '\'' +
                ", customer_product_product_id='" + customer_product__product_id + '\'' +
                ", customer_product_mst_model_id='" + customer_product__mst_model_id + '\'' +
                ", problems_id='" + problems_id + '\'' +
                ", problems_remark='" + problems_remark + '\'' +
                '}';
    }

    public CreateJobBean(String mst_service_location_id, String mst_platform_id, String mst_warrenty_status_id, String mst_oem_id, String customer__first_name, String customer__last_name, String customer__mobile_number, String customer__mobile_number_alt, String customer__email_id, String customer__email_id_alt, String customer_address__flat_number, String customer_address__apartment_name, String customer_address__street_name, String customer_address__landmark, String customer_address__area, String customer_address__pincode, String customer_address__country, String customer_address__state, String customer_product__dop, String customer_product__serial_number, String customer_product__imei1, String customer_product__imei2, String customer_product__popurl, String customer_product__product_id, String customer_product__mst_model_id, String problems_id, String problems_remark) {
        super();
        ...
        this.problems_remark = problems_remark;
    }
    ...
    public String getProblems_remark() {
        return problems_remark;
    }
    ...
    public void setProblems_id(String problems_id) {
        this.problems_id = problems_id;
    }

    public void setProblems_remark(String problems_remark) {
        this.problems_remark = problems_remark;
    }
}
